        ...
        <ScrollView>
            <View style={{ padding: 20 }}>
                ...
                <View style={{ flexDirection: "row" }}>
                    <Image style={{ flex: 1, resizeMode: "cover", aspectRatio: 3 / 2 }} source={require("../assets/projectres/room-1.jpg")} />
                </View>
                {/* View ก้อนที่ 3 */}
                <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 50 }}>The Palace Hotel</Text>
                </View>
                {/* View ก้อนที่ 4 */}
                ...
                {/* View ก้อนที่ 5 */}
                <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 20, color: 'black' }} >โรงแรมอันดับที่ 95 จาก 340 แห่งในประเทศไทย</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', marginTop: 10, padding: 5 }}>
                    ...
                    <View>
                        <Text style={{ color: "black", fontSize: 30, marginLeft: -69, marginTop: 30, fontWeight: 'bold' }}>$179</Text>
                    </View>
                </View>
                <TouchableOpacity onPress={onPressButton}>
                    <View style={{ padding: 25, backgroundColor: "#f4a72c", borderRadius: 40 }}>
                ...
                <TouchableOpacity onPress={onPressButton}>
                    <View style={{ padding: 25, backgroundColor: "#f6f115", borderRadius: 40, marginTop: 10 }}>
                        <Text style={{ fontSize: 20, textAlign: "center", color: 'black', fontWeight: 'bold' }}>
                            จองเลย
                        </Text>
                    </View>
