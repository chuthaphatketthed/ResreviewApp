        ...
        <ScrollView>
            <View style={{ padding: 30 }}>
                ...
                <View style={{ flexDirection: "row" }}>
                    <Image style={{ flex: 1, resizeMode: "cover", aspectRatio: 3 / 2 }} source={require("../assets/img/hotellist3.jpg")} />
                </View>
                {/* View ก้อนที่ 3 */}
                <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 50 }}>Skyline Resort</Text>
                </View>
                {/* View ก้อนที่ 4 */}
                <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 5 }}>
                    <View style={{ flexDirection: "row" }}>
                        ...
                        <Text style={{ fontSize: 20, paddingLeft: 10 }}>รีวิว 120 รายการ</Text>
                    </View>
                </View>
                {/* View ก้อนที่ 5 */}
                <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 20, color: 'black' }} >โรงแรมอันดับที่ 210 จาก 340 แห่งในประเทศไทย</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', marginTop: 10, padding: 5 }}>
                    ...
                    <View style={{ marginLeft: 100 }}>
                        <Text style={{ color: "grey", fontSize: 20, marginLeft: 175, marginTop: 10, textDecorationLine: 'line-through' }}>$100</Text>
                    </View>
                    <View>
                        <Text style={{ color: "black", fontSize: 30, marginLeft: -69, marginTop: 30, fontWeight: 'bold' }}>$98</Text>
                    </View>
                </View>
                <View style={{ marginTop: 20 }}>
                    ...
                    <MapView
                        ...
                        initialRegion={{
                            latitude: 8.467349, // แก้ไขเป็นพิกัดของสถานที่ที่ต้องการ
                            longitude: 100.188828, // แก้ไขเป็นพิกัดของสถานที่ที่ต้องการ
