        ...
        <ScrollView>
            <View style={{ padding: 30 }}>
                ...
                <View style={{ flexDirection: "row" }}>
                    <Image style={{ flex: 1, resizeMode: "cover", aspectRatio: 3 / 2 }} source={require("../assets/img/hotellist5.jpg")} />
                </View>
                {/* View ก้อนที่ 3 */}
                <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 50 }}>Damview Resort</Text>
                </View>
                {/* View ก้อนที่ 4 */}
                ...
                {/* View ก้อนที่ 5 */}
                <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 20, color: 'black' }} >โรงแรมอันดับที่ 111 จาก 340 แห่งในประเทศไทย</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', marginTop: 10, padding: 5 }}>
                    ...
                    <View style={{ marginLeft: 100 }}>
                        <Text style={{ color: "grey", fontSize: 20, marginLeft: 175, marginTop: 10, textDecorationLine: 'line-through' }}>$160</Text>
                    </View>
                    <View>
