...
export default function Rese6() {


    const navigation = useNavigation();
    const onPressButton = async () => {
        const bookingDetails = {
            hotelName: 'Riverside Grand Hotel',
            checkInDate: '25 ส.ค.',
            checkOutDate: '28 ส.ค.',
            rooms: 1,
            guests: 2,
        ...
        <ScrollView>
            <View style={{ padding: 30 }}>
                ...
                <View style={{ flexDirection: "row" }}>
                    <Image style={{ flex: 1, resizeMode: "cover", aspectRatio: 3 / 2 }} source={require("../assets/img/hotellist6.jpg")} />
                </View>
                {/* View ก้อนที่ 3 */}
                <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 50 }}>Riverside Grand Hotel</Text>
                </View>
                {/* View ก้อนที่ 4 */}
                <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 5 }}>
                    <View style={{ flexDirection: "row" }}>
                        ...
                        <Text style={{ fontSize: 20, paddingLeft: 10 }}>รีวิว 460 รายการ</Text>
                    </View>
                </View>
                {/* View ก้อนที่ 5 */}
                <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 20, color: 'black' }} >โรงแรมอันดับที่ 154 จาก 340 แห่งในประเทศไทย</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', marginTop: 10, padding: 5 }}>
                    ...
                    <View>
                        <Text style={{ color: "black", fontSize: 30, marginLeft: -69, marginTop: 30, fontWeight: 'bold' }}>$59</Text>
                    </View>
                </View>
                <View style={{ marginTop: 20 }}>
                    ...
                    <MapView
                        ...
                        initialRegion={{
                            latitude: 13.690905,// แก้ไขเป็นพิกัดของสถานที่ที่ต้องการ
                            longitude: 100.510661, // แก้ไขเป็นพิกัดของสถานที่ที่ต้องการ
