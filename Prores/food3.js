...
export default function Food3() {
    ...
    const handleBooking = async () => {
        const bookingData = {
          restaurantName: "ร้าน Pizza manoliz",
    ...
    return (
        <ScrollView>
            <View style={{ padding: 30 }}>
                ...
                <Text style={{ fontSize: 20, alignSelf: 'center', paddingBottom: 10, marginTop: -25 }}> ร้าน Pizza manoliz </Text>
                <View style={{ flexDirection: "row" }}>
                    <Image style={{ flex: 1, resizeMode: "cover", aspectRatio: 3 / 2 }} source={require("../assets/projectres/pizza1.jpg")} />
                </View>
                {/* View ก้อนที่ 3 */}
                <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 50 }}>ร้าน Pizza manoliz</Text>
                </View>
                {/* View ก้อนที่ 4 */}
                ...
                {/* View ก้อนที่ 5 */}
                <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 20, color: 'black' }} >ร้านอาหารอันดับที่ 167 จาก 340 แห่งในประเทศไทย</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', marginTop: 10, padding: 5 }}>
                    ...
                    <View style={{ marginLeft: 100 }}>
                        <Text style={{ color: "grey", fontSize: 20, marginLeft: 155, marginTop: 10, textDecorationLine: 'line-through' }}>$80</Text>
                    </View>
                    <View>
                        <Text style={{ color: "black", fontSize: 30, marginLeft: -69, marginTop: 30, fontWeight: 'bold' }}>$69</Text>
                    </View>
                </View>
                <View style={{ marginTop: 20 }}>
                    ...
                    <MapView
                        ...
                        initialRegion={{
                            latitude: 13.693214,  // แก้ไขเป็นพิกัดของสถานที่ที่ต้องการ
                            longitude: 100.525017, // แก้ไขเป็นพิกัดของสถานที่ที่ต้องการ
