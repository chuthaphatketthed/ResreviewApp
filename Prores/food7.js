    ...
    return (
        <ScrollView>
            <View style={{ padding: 30 }}>
                ...
                <Text style={{ fontSize: 20, alignSelf: 'center', paddingBottom: 10, marginTop: -25 }}> ร้าน Konum BBQ </Text>
                <View style={{ flexDirection: "row" }}>
                    <Image style={{ flex: 1, resizeMode: "cover", aspectRatio: 3 / 2 }} source={require("../assets/projectres/bbq1.jpg")} />
                </View>
                {/* View ก้อนที่ 3 */}
                <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 50 }}>ร้าน Konum BBQ</Text>
                </View>
                {/* View ก้อนที่ 4 */}
                <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 5 }}>
                    <View style={{ flexDirection: "row" }}>
                        ...
                        <Text style={{ fontSize: 20, paddingLeft: 10 }}>รีวิว 930 รายการ</Text>
                    </View>
                </View>
                {/* View ก้อนที่ 5 */}
                <View style={{ marginTop: 10 }}>
                    <Text style={{ fontSize: 20, color: 'black' }} >ร้านอาหารอันดับที่ 144 จาก 340 แห่งในประเทศไทย</Text>
                </View>
                ...
                <View style={{ marginTop: 20 }}>
                    ...
                    <MapView
                        ...
                        initialRegion={{
                            latitude: 13.788511, // แก้ไขเป็นพิกัดของสถานที่ที่ต้องการ
                            longitude: 100.474533, // แก้ไขเป็นพิกัดของสถานที่ที่ต้องการ
